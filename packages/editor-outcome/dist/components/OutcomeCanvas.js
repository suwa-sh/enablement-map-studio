...
export function OutcomeCanvas({ outcome, sbp, cjm, selectedPhaseId, onPhaseSelect, onTaskClick, }) {
    ...
    return (_jsxs(Box, { sx: { height: '100%', bgcolor: 'grey.50', p: 3 }, children: [cjm && (_jsxs(Paper, { elevation: 2, sx: { mb: 3, p: 2 }, children: [_jsx(Typography, { variant: "h6", sx: { mb: 2 }, children: "CJM\u30D5\u30A7\u30FC\u30BA" }), _jsxs(Stack, { direction: "row", spacing: 1, flexWrap: "wrap", useFlexGap: true, children: [_jsx(Button, { onClick: () => onPhaseSelect(null), variant: selectedPhaseId === null ? 'contained' : 'outlined', children: "\u3059\u3079\u3066" }), cjm.phases.map((phase) => (_jsx(Button, { onClick: () => onPhaseSelect(phase.id), variant: selectedPhaseId === phase.id ? 'contained' : 'outlined', children: phase.name }, phase.id)))] })] })), _jsxs(Paper, { elevation: 2, sx: { p: 2 }, children: [_jsx(Typography, { variant: "h6", sx: { mb: 2 }, children: "SBP" }), _jsx(Stack, { spacing: 2, children: sbp.lanes.map((lane) => {

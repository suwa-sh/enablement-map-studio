...
export function CjmCanvas({ cjm, selectedAction, selectedPhase, onActionSelect, onPhaseSelect, onAddPhase, onAddAction, onReorderActions, onReorderPhases, }) {
    ...
    return (_jsxs(Box, { sx: { p: 3, height: '100%', overflow: 'auto' }, children: [_jsxs(Stack, { direction: "row", spacing: 2, sx: { mb: 2 }, children: [_jsx(Button, { variant: "contained", startIcon: _jsx(Add, {}), onClick: onAddPhase, children: "\u30D5\u30A7\u30FC\u30BA\u8FFD\u52A0" }), _jsx(Button, { variant: "contained", startIcon: _jsx(Add, {}), onClick: handleOpenAddActionDialog, children: "\u30A2\u30AF\u30B7\u30E7\u30F3\u8FFD\u52A0" })] }), _jsx(TableContainer, { component: Paper, elevation: 2, sx: { overflowX: 'auto' }, children: _jsxs(Table, { sx: { minWidth: 650 }, children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { sx: { width: 140, minWidth: 140, bgcolor: 'grey.100', fontWeight: 'bold', whiteSpace: 'nowrap', p: 3 }, children: "\u30D5\u30A7\u30FC\u30BA" }), _jsx(DndContext, { sensors: sensors, collisionDetection: closestCenter, onDragEnd: handleDragEndPhases, children: _jsx(SortableContext, { items: cjm.phases.map((p) => p.id), strategy: horizontalListSortingStrategy, children: phaseActionsMap.map(({ phase, actions }) => {

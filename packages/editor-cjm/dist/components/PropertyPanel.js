...
export function PropertyPanel({ selectedAction, selectedPhase, selectedPersona, onActionUpdate, onPhaseUpdate, onPersonaUpdate, onActionDelete, onPhaseDelete, onClose, }) {
    ...
    return (_jsx(Drawer, { anchor: "right", open: open, onClose: onClose, variant: "temporary", children: _jsxs(Box, { sx: { width: '33vw', minWidth: 400, p: 3 }, children: [_jsxs(Box, { sx: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3 }, children: [_jsx(Typography, { variant: "h6", children: editedPersona ? 'ペルソナ' : 'Properties' }), _jsx(IconButton, { onClick: onClose, size: "small", children: _jsx(Close, {}) })] }), editedPersona && (_jsxs(Stack, { spacing: 3, children: [_jsx(TextField, { label: "\u30DA\u30EB\u30BD\u30CA\u540D", fullWidth: true, value: editedPersona.name, onChange: (e) => setEditedPersona({ ...editedPersona, name: e.target.value }) }), _jsx(TextField, { label: "\u8AAC\u660E", fullWidth: true, multiline: true, rows: 6, value: editedPersona.description || '', onChange: (e) => setEditedPersona({ ...editedPersona, description: e.target.value }), placeholder: "\u30DA\u30EB\u30BD\u30CA\u306E\u8AAC\u660E\u3092\u5165\u529B" }), _jsx(Button, { variant: "contained", startIcon: _jsx(Save, {}), onClick: handleSave, fullWidth: true, children: "Save" })] })), editedPhase && (_jsxs(Stack, { spacing: 3, children: [_jsx(TextField, { label: "\u30D5\u30A7\u30FC\u30BA\u540D", fullWidth: true, value: editedPhase.name, onChange: (e) => setEditedPhase({ ...editedPhase, name: e.target.value }) }), _jsxs(Stack, { direction: "row", spacing: 1, children: [_jsx(Button, { variant: "contained", startIcon: _jsx(Save, {}), onClick: handleSave, sx: { flex: 1 }, children: "Save" }), _jsx(Button, { variant: "contained", color: "error", startIcon: _jsx(Delete, {}), onClick: handleDelete, sx: { flex: 1 }, children: "Delete" })] })] })), editedAction && (_jsxs(Stack, { spacing: 3, children: [_jsx(TextField, { label: "\u30A2\u30AF\u30B7\u30E7\u30F3", fullWidth: true, value: editedAction.name, onChange: (e) => setEditedAction({ ...editedAction, name: e.target.value }) }), _jsx(TextField, { label: "\u30BF\u30C3\u30C1\u30DD\u30A4\u30F3\u30C8", fullWidth: true, multiline: true, rows: 3, value: editedAction.touchpoints?.join('\n') || '', onChange: (e) => setEditedAction({
                                ...editedAction,
